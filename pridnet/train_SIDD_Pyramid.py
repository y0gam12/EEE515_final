...
dir_name = 'C:/Users/yogam/Documents/School/EEE515/SIDD_Medium_Raw/Data'
checkpoint_dir = 'C:/Users/yogam\Documents/School/EEE515/checkpoint/SIDD_Pyramid/'
result_dir = 'C:/Users/yogam\Documents/School/EEE515/result/SIDD_Pyramid/'
...
for epoch in range(lastepoch, max_epoch+1):
    ...
    for ind in np.random.permutation(len(train_ids)):
        ...
        if epoch % save_freq == 0:
            ...
            #save_img(result_dir + '%04d/%04d_00_train.jpg' % (epoch, int(train_id)), img)
            img = toimage(temp*255, high=255, low=0, cmin=0, cmax=255, pal=None,
            mode=None, channel_axis=None)
            path = result_dir + '%04d/%04d_00_train.jpg' % (epoch, int(train_id))
